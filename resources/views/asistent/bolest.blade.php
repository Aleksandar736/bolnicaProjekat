...
<body>
            ...
            <table class="table table-striped table-sm table-responsive-sm">
                <thead>
                    <tr>
                        ...
                        <th>Naziv</th>
                        <th>Opis</th>
                        <th colspan="2"><a href="/asistent/bolest/forma_bolest/" class="btn btn-success" id="bolesti">DODAJ NOVU BOLEST</a></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    <tr>
                        ...
                        <td><?=$row->naziv?></td>
                        <td><?=$row->opis?></td>
                        <td width='90px'><a href="/asistent/bolest/forma_bolest/<?=$row->bolest_id?>" class="btn btn-primary">IZMENI</a></td>
                        <td width='90px'>
                            <form method="POST" action="/asistent/bolest/<?=$row->bolest_id?>" >
                            <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        {
        $('#data-table').load("{{ route('live_search_bolest.action') }}?query=" + query + " #data-table")
        }
