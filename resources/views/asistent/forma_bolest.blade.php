...
<body>
    ...
    <div id="container2" class="row">
        ...
        <!--srednji deo - forma-->
        <div id="container1" class="col-lg-10">
            <form method="POST" action="/asistent/bolest" >
            ...
            <div class="card-body">
                <?php echo csrf_field(); ?>
                <?php   
                    if($bolest->bolest_id > 0){
                        echo '<input type="hidden" name="_method" value="PUT" />';
                        echo '<input name="bolest_id" value="'.$bolest->bolest_id.'" type="hidden" />';
                    }
                ?>                
                <div class="col-md-9">
                        ...
                        <div class="card-body ">
                            <form method="POST" action="/asistent/bolest">
                                <div class="form-group">
                                    <label>Naziv</label>
                                    <input type="text" name='naziv' value='<?=$bolest->naziv?>' class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Opis bolesti</label><br>
                                    <textarea rows="4" cols="50" name='opis' value='<?=$bolest->opis?>' class="form-control"><?=$bolest->opis?></textarea>
                                </div>
                            ...
                            <div class="card-footer ">
                                <a href="/asistent/bolest" class="btn btn-fill btn-info rosybrown">Povratak na prethodnu stranu</a>                            
                            </div>
                        </div>
                    </div>
                </div>                   
