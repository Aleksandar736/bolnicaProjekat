...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div id="container2" class="row">
            ...
            <!--srednji deo-->
            <div id="container1" class="col-lg-10">
                <form method="POST" action="/asistent/pregledi" name="myForm" onsubmit="return validateForm()" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" cols="24" id="opis" name="opis"  > {{$pregled->opis}} </textarea>
                                </div>
                            </div>      
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row" style="margin-top: 30px;">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    <a href="/asistent/pregledi" class="btn btn-fill btn-info rosybrown">Povratak na prethodnu stranu</a>
                                </div>
                            </div>
                        </div>
                        <!--kraj treceg reda-->
