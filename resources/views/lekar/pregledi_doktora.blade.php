...
<body>
            ...
            <table class="table table-striped table-sm table-responsive-sm">
                <thead>
                    <tr>
                        ...
                        <th>Uput</th>
                        <th colspan="2"><a href="/lekar/pregledi_doktora/forma_pregled_doktor" class="btn btn-success" id="dodavanje">DODAJ NOVI PREGLED</a></th>
                    </tr>
                </thead>
                <tbody>               
                    <?php                      
                    ...
                    <tr>
                        ...
                        <?=$lek->naziv?> (<?=$lek->pivot->kolicina?>), 
                        <?php } ?>
                        </td>
                        <td><?=$row->uput ? $row->uput->specijalista : ''?></td>
                        <td width='90px'><a href="/lekar/pregledi_doktora/forma_pregled_doktor/<?=$row->pregledi_id?>" class="btn btn-primary">IZMENI</a></td>
                        <td width='90px'>
                            <form method="POST" action="/lekar/pregledi_doktora/<?=$row->pregledi_id?>" >
                                <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        {
        $('#data-table').load("{{ route('live_search_pregledi_doktora.action') }}?query=" + query + " #data-table")
        }
